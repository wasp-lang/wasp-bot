...
export async function generateDailyReport(prefetchedEvents = undefined, numPeriods = undefined) {
  return generatePeriodReport(numPeriods ?? 14, 'day', prefetchedEvents, false)
}

export async function generateWeeklyReport(prefetchedEvents = undefined, numPeriods = undefined) {
  return generatePeriodReport(numPeriods ?? 12, 'week', prefetchedEvents)
}

export async function generateMonthlyReport(prefetchedEvents = undefined, numPeriods = undefined) {
